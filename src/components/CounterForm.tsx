...
export const CounterForm = () => {
  ...
  return (
    <form onSubmit={handleIncrement}>
      ...
      <div>
        <label className="text-sm font-bold text-gray-700" htmlFor="increment">
          ...
          <input
            id="increment"
            type="number"
            className="ml-2 w-32 appearance-none rounded-sm border border-secondary-dark px-2 py-1 text-sm/tight text-gray-700 focus:ring-3 focus:ring-blue-300/50 focus:outline-hidden"
      ...
      <div className="mt-2">
        <button
          className="rounded-sm bg-primary-light px-5 py-1 font-bold text-white hover:bg-primary focus:ring-3 focus:ring-blue-300/50 focus:outline-hidden disabled:pointer-events-none disabled:opacity-50"
          type="submit"
